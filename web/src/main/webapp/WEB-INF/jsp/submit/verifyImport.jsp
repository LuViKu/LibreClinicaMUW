...
<jsp:useBean scope='session' id='version' class='at.ac.meduniwien.ophthalmology.libreclinica.bean.submit.CRFVersionBean'/>
...
<jsp:useBean scope='session' id='summaryStats' class='at.ac.meduniwien.ophthalmology.libreclinica.bean.submit.crfdata.SummaryStatsBean'/>
