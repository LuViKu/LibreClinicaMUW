...
<jsp:useBean scope="request" id="displayEvent" class="at.ac.meduniwien.ophthalmology.libreclinica.bean.managestudy.DisplayStudyEventBean"/>
...
<jsp:useBean scope="request" id="study" class="at.ac.meduniwien.ophthalmology.libreclinica.bean.managestudy.StudyBean"/>
