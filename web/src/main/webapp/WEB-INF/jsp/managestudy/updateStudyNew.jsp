...
<fmt:setBundle basename="at.ac.meduniwien.ophthalmology.libreclinica.i18n.admin" var="resadmin"/>
...
<jsp:useBean scope='request' id='parentStudy' class='at.ac.meduniwien.ophthalmology.libreclinica.bean.managestudy.StudyBean'/>
<jsp:useBean scope='request' id='studyToView' class='at.ac.meduniwien.ophthalmology.libreclinica.bean.managestudy.StudyBean'/>
