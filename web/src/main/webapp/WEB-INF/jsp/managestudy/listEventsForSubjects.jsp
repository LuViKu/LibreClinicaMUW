...
<%-- Phase B.4 jmesa PR 6b (cohort 4b): jmesa scripts dropped — the
     matrix is rendered client-side by include/listEventsForSubjectsTable.jsp.
     The add-new-subject overlay still uses jQuery.blockUI so we keep
     loading just that one script. --%>
...
<div id="findSubjectsDiv">
    <jsp:include page="include/listEventsForSubjectsTable.jsp"/>
</div>
