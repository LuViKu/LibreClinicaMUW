...
<!-- start of login/changeStudyConfirm.jsp -->
...
<jsp:useBean scope="session" id="studyWithRole" class="at.ac.meduniwien.ophthalmology.libreclinica.bean.login.StudyUserRoleBean"/>
...
<!-- end of login/changeStudyConfirm.jsp -->
