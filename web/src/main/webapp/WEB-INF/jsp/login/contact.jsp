...
<jsp:useBean scope="session" id="newUserBean" class="at.ac.meduniwien.ophthalmology.libreclinica.bean.login.UserAccountBean"/>
...
<div class="textbox_center">
	<table>
		<tr>
			<td class="formlabel"><fmt:message key="your_name" bundle="${resword}"/>:</td>
		...
		<tr>
			<td class="formlabel"><fmt:message key="your_email" bundle="${resword}"/>:</td>
			<td><div class="formfieldXL_BG"><input type="text" name="email" value="<c:out value="${email}"/>" class="formfieldXL"></div>
			<jsp:include page="../showMessage.jsp"><jsp:param name="key" value="email"/></jsp:include></td>
		</tr>
		<tr>
			<td class="formlabel"><fmt:message key="subject_of_your_question" bundle="${resword}"/>:</td>
		...
		<tr>
			<td class="formlabel"><fmt:message key="your_message" bundle="${resword}"/>:</td>
			<td><div class="formtextareaXL4_BG"><textarea name="message" class="contact_message"><c:out value="${message}"/></textarea></div>
 ...
 <table>
 	<tr><td><input type="submit" name="submit" value="<fmt:message key="submit" bundle="${resword}"/>" class="button_medium"></td>
	<td><input type="button" name="cancel" value="<fmt:message key="cancel" bundle="${resword}"/>" class="button_medium" onclick="javascript:window.location.href='MainMenu'"></td></tr>
</table>
</form>

<!-- end of login/contact.jsp -->
