 ...
 *                               data-entry-started | completed |
 *                               stopped | skipped | locked | signed}
 * @param repeating              whether the def has repeating=true
 * @param scheduledFor           nAMD T-and-E (2026-06-19): the date the
 *                               coordinator / auto-scheduler intended
 *                               this visit to happen, derived from
 *                               {@code dateStarted +
 *                               scheduledIntervalDays}; null on legacy
 *                               + non-T-and-E rows
 * @param scheduledIntervalDays  nAMD T-and-E (2026-06-19): the interval
 *                               in days from the prior visit that the
 *                               physician chose at the end of the
 *                               prior visit; null on legacy + non-T-
 *                               and-E rows
 */
