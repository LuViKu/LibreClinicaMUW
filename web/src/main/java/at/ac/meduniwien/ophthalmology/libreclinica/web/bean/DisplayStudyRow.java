...
public class DisplayStudyRow extends EntityBeanRow<DisplayStudyBean, DisplayStudyRow> {
     ...
     * 
     * @see
     * at.ac.meduniwien.ophthalmology.libreclinica.core.EntityBeanRow#compareColumn(java.lang.Object,
     * int)
     */
    @Override
     ...
     * 
     * @see
     * at.ac.meduniwien.ophthalmology.libreclinica.core.EntityBeanRow#generatRowsFromBeans(java.util
     * .ArrayList)
     */
    @Override
