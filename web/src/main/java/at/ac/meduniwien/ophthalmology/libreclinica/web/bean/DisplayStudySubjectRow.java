 ...
 */
package at.ac.meduniwien.ophthalmology.libreclinica.web.bean;

import at.ac.meduniwien.ophthalmology.libreclinica.bean.core.SubjectEventStatus;
import at.ac.meduniwien.ophthalmology.libreclinica.bean.managestudy.DisplayStudySubjectBean;
...
public class DisplayStudySubjectRow extends EntityBeanRow<DisplayStudySubjectBean, DisplayStudySubjectRow> {
     ...
     * (non-Javadoc)
     *
     * @see at.ac.meduniwien.ophthalmology.libreclinica.core.EntityBeanRow#compareColumn(java.lang.Object,
     *      int)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see at.ac.meduniwien.ophthalmology.libreclinica.core.EntityBeanRow#generatRowsFromBeans(java.util.ArrayList)
     */
    @Override
