...
// Phase E.6 (POI 5.3.0): switch onto CellType enum (CELL_TYPE_* removed in 4.0).
...
public final class SpreadsheetPreviewNw implements Preview {
    ...
    private static final Logger logger = LoggerFactory.getLogger("at.ac.meduniwien.ophthalmology.libreclinica.control.admin.SpreadsheetPreviewNw");
