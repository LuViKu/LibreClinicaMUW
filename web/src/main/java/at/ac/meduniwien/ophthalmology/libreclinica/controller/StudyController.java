...
import at.ac.meduniwien.ophthalmology.libreclinica.bean.login.ErrorObject;
import at.ac.meduniwien.ophthalmology.libreclinica.bean.login.EventDefinitionDTO;
import at.ac.meduniwien.ophthalmology.libreclinica.bean.login.ResponseSuccessEventDefDTO;
import at.ac.meduniwien.ophthalmology.libreclinica.bean.login.ResponseSuccessSiteDTO;
import at.ac.meduniwien.ophthalmology.libreclinica.bean.login.ResponseSuccessStudyDTO;
import at.ac.meduniwien.ophthalmology.libreclinica.bean.login.SiteDTO;
import at.ac.meduniwien.ophthalmology.libreclinica.bean.login.StudyDTO;
import at.ac.meduniwien.ophthalmology.libreclinica.bean.login.StudyUserRoleBean;
import at.ac.meduniwien.ophthalmology.libreclinica.bean.login.UserAccountBean;
import at.ac.meduniwien.ophthalmology.libreclinica.bean.login.UserRole;
...
public class StudyController {
	...
	public ResponseEntity<Object> createNewStudy(HttpServletRequest request, @RequestBody HashMap<String, Object> map) throws Exception {
		...
		if (assignUserRoles != null) {
			...
			for (Object userRole : assignUserRoles) {
				...
				ResourceBundle resterm = at.ac.meduniwien.ophthalmology.libreclinica.i18n.util.ResourceBundleProvider.getTermsBundle();
	...
	public Boolean verifyProtocolTypeExist(String protocolType) {
		ResourceBundle resadmin = at.ac.meduniwien.ophthalmology.libreclinica.i18n.util.ResourceBundleProvider.getAdminBundle();
	...
	public void validateUniqueProId(HttpServletRequest request, HashMap<String, ArrayList<String>> errors) {
		...
		for (StudyBean thisBean : allStudies) {
			if (request.getAttribute("uniqueProId") != null && request.getAttribute("uniqueProId").equals(thisBean.getIdentifier())) {
				ResourceBundle resexception = at.ac.meduniwien.ophthalmology.libreclinica.i18n.util.ResourceBundleProvider.getExceptionsBundle();
