...
public class AuditApiController {
     ...
     */
    static final int AUDIT_TYPE_AUDIT_LOG_EXPORTED = 54;
     ...
     * {@code audit_log_event} row (type 54) per successful download
    ...
    private static String variantForType(int typeId, String reasonForChange) {
        ...
        return switch (typeId) {
            ...
            // dataset-export (52, Phase E.6 — SPA dataset download +
            // retention GC), subject-data-export (53, Phase E.6 P5 —
            // per-subject CRF PDF/CSV download), audit-log-export
            // (54, Phase E.6 — XLSX hand-off of the audit trail) and
            // discrepancy-log-export (55, Phase E.6 — CSV hand-off of
            // the discrepancy list) edits — all administrative actions
            // surface under the existing "Admin" filter rather than
            // the data-stream bucket so operators reviewing the audit
            // trail can pivot by intent.
            case 2, 3, 4, 5, 6, 7, 9, 27, 33, 50, 51, 52, 53, 54, 55 -> "admin";
