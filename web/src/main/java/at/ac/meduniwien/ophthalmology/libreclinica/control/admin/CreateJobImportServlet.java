...
import at.ac.meduniwien.ophthalmology.libreclinica.web.job.TriggerService;
    ...
    protected void processRequest() throws Exception {
        ...
        if (action == null || action.trim().isEmpty()) {
            ...
            if (!errors.isEmpty()) {
                ...
                jobDetailBean.setJobClass(at.ac.meduniwien.ophthalmology.libreclinica.web.job.ImportStatefulJob.class);
