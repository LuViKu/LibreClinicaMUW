...
| E.2 — Tailwind v4 + MUW tokens | ✅ shipped 2026-05-30 | [src/style.css](src/style.css), Histoire stories |
| E.3 — Shared component library | ⏳ in progress (3/10 primitives) | TopBar, SideRail, StatusPill |
