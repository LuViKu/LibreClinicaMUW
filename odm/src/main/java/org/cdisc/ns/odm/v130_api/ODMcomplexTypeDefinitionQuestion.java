 ...
 *         &lt;group ref="{http://www.cdisc.org/ns/odm/v1.3-api}QuestionElementExtension" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attGroup ref="{http://www.cdisc.org/ns/odm/v1.3-api}QuestionAttributeExtension"/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class ODMcomplexTypeDefinitionQuestion {
    ...
    @XmlAttribute(name = "QuestionNumber", namespace = "http://www.openclinica.org/ns/odm_ext_v130/v3.1-api")
