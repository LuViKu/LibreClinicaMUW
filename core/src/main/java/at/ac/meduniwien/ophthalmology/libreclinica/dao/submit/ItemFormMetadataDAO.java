 ...
 */
package at.ac.meduniwien.ophthalmology.libreclinica.dao.submit;
...
public class ItemFormMetadataDAO extends EntityDAO<ItemFormMetadataBean> {
     ...
     * (non-Javadoc)
     *
     * @see at.ac.meduniwien.ophthalmology.libreclinica.dao.core.DAOInterface#getEntityFromHashMap(java.util.HashMap)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see at.ac.meduniwien.ophthalmology.libreclinica.dao.core.DAOInterface#findAll(java.lang.String,
     ...
     * (non-Javadoc)
     *
     * @see at.ac.meduniwien.ophthalmology.libreclinica.dao.core.DAOInterface#findAllByPermission(java.lang.Object,
