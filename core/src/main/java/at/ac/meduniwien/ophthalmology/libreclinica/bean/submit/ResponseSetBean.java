...
public class ResponseSetBean extends EntityBean {
    ...
    private at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType responseType;
    ...
    public ResponseSetBean() {
        super();
        setResponseType(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.TEXT);
     ...
     */
    public at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType getResponseType() {
        return responseType;
    }
    ...
    public void setResponseTypeId(int responseTypeId) {
        responseType = at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.get(responseTypeId);
    }
