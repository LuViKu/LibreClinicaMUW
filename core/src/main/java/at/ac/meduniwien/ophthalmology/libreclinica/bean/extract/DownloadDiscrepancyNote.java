 ...
 * @see at.ac.meduniwien.ophthalmology.libreclinica.control.extract.DiscrepancyNoteOutputServlet
...
public class DownloadDiscrepancyNote implements DownLoadBean{
    ...
    public void downLoad(EntityBean bean,
        ...
        if(bean == null || stream == null ||
          !( bean instanceof at.ac.meduniwien.ophthalmology.libreclinica.bean.managestudy.DiscrepancyNoteBean)){
