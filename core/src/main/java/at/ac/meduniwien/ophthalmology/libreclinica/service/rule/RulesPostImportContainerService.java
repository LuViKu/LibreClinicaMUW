...
import at.ac.meduniwien.ophthalmology.libreclinica.domain.rule.RunOnSchedule;
...
import at.ac.meduniwien.ophthalmology.libreclinica.domain.rule.expression.ExpressionProcessor;
import at.ac.meduniwien.ophthalmology.libreclinica.domain.rule.expression.ExpressionProcessorFactory;
import at.ac.meduniwien.ophthalmology.libreclinica.service.rule.expression.ExpressionService;
import at.ac.meduniwien.ophthalmology.libreclinica.validator.rule.action.EventActionValidator;
import at.ac.meduniwien.ophthalmology.libreclinica.validator.rule.action.InsertActionValidator;
import at.ac.meduniwien.ophthalmology.libreclinica.validator.rule.action.RandomizeActionValidator;
...
public class RulesPostImportContainerService {
    ...
    private void isRuleActionValid(RuleActionBean ruleActionBean, AuditableBeanWrapper<RuleSetBean> ruleSetBeanWrapper,
        ...
        RuleActionRunBean ruleActionRun= ruleActionBean.getRuleActionRun();
           ...
           String message ="";
         String emailSubject="";
		if (ruleActionBean instanceof at.ac.meduniwien.ophthalmology.libreclinica.domain.rule.action.NotificationActionBean){
		...
		if (ruleActionBean instanceof at.ac.meduniwien.ophthalmology.libreclinica.domain.rule.action.EmailActionBean)
