...
import at.ac.meduniwien.ophthalmology.libreclinica.service.crfdata.SCDData;
...
public class DisplayItemBean implements Comparable<DisplayItemBean> {
    ...
    public void setMetadata(ItemFormMetadataBean metadata) {
        ...
        if (rt.equals(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.CHECKBOX) || rt.equals(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.RADIO)
            || rt.equals(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.SELECT) || rt.equals(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.SELECTMULTI)) {
    ...
    public void loadFormValue(String value) {
        ...
        if (rt.equals(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.TEXT) || rt.equals(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.TEXTAREA) //|| rt.equals(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.CODING)
            || rt.equals(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.CALCULATION) || rt.equals(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.GROUP_CALCULATION)
            || rt.equals(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.FILE) || rt.equals(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.INSTANT_CALCULATION)) {
            rsb.setValue(value);
        } else {
            if (value != null) {
                rsb.setSelected(value.trim(), true);
    ...
    public void loadDBValue() {
        ...
        } else if (rt.equals(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.TEXT) || rt.equals(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.TEXTAREA) //|| rt.equals(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.CODING)
            || rt.equals(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.CALCULATION) || rt.equals(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.GROUP_CALCULATION)
            || rt.equals(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.INSTANT_CALCULATION)) {
            rsb.setValue(dbValue);
        } else if (rt.equals(at.ac.meduniwien.ophthalmology.libreclinica.bean.core.ResponseType.FILE)) {
