...
import static at.ac.meduniwien.ophthalmology.libreclinica.domain.user.AuthType.MARKED;
import static at.ac.meduniwien.ophthalmology.libreclinica.domain.user.AuthType.STANDARD;
import static at.ac.meduniwien.ophthalmology.libreclinica.domain.user.AuthType.TWO_FACTOR;
...
import at.ac.meduniwien.ophthalmology.libreclinica.domain.user.AuthType;
