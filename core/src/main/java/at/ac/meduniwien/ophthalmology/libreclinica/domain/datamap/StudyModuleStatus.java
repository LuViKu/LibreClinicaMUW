 ...
 */
// Phase B.5: explicit entity name to avoid collision with
// managestudy.StudyModuleStatus when Hibernate 6 scans both via
// packagesToScan. The legacy annotatedClasses list registered only the
// managestudy variant; this class is unused in the codebase but kept
