...
public class EventCRFBean extends AuditableEntityBean {
    ...
    private at.ac.meduniwien.ophthalmology.libreclinica.domain.Status nexGenStatus;
    ...
    public EventCRFBean() {
        ...
        nexGenStatus = at.ac.meduniwien.ophthalmology.libreclinica.domain.Status.INVALID;
    }
    ...
    public at.ac.meduniwien.ophthalmology.libreclinica.domain.Status getNexGenStatus() {
        return nexGenStatus;
    }

    public void setNexGenStatus(at.ac.meduniwien.ophthalmology.libreclinica.domain.Status nexGenStatus) {
