...
import static at.ac.meduniwien.ophthalmology.libreclinica.domain.admin.TwoFactorType.APPLICATION;
...
import at.ac.meduniwien.ophthalmology.libreclinica.domain.admin.TwoFactorType;
...
public class TwoFactorService {
    ...
    public void printoutCertificate(CertificateBean bean, OutputStream outStream) throws Exception {
        ...
        paragraph2.addText("User: " + bean.getUsername() + "\n", 14, COURIER);
